				  ...
				  <table id = "example" class="row-border display compact hover" cellspacing="0">
					...
					<tbody>
					   <?php
						...
						?>
						  <td>
							<a href="view_user_delete.php?reject_id=<?php echo $row['memberID']; ?>" onclick = "return confirm('Sure to Delete this user?'); " data-toggle="tooltip" title="Delete User"><i class = "fa fa-trash-o"></i></a>
							</td>
						</tr>
						<?php  						
						}
