<?php 
	...
	if(!empty($_POST['event_name']) and !empty($_POST['event_date']) and !empty($_POST['time_from'])
	 ...
	 //data insert sql
        $sql = "INSERT into `event` (Event_name,Event_image, Event_date, Event_time_from, Event_time_to, Event_venue, Event_organizer,Event_expiration)
                  VALUES('$name','$image1','$date','$time_from','$time_to','$venue','$organizer','No')"; 
        $res = $conn->query($sql);
        if ($res == true) {
            ...
            <div class="col-md-9">
                ...
                <div class="row carousel-holder">
					...
					<form class="form-horizontal" action ="" method="post" enctype="multipart/form-data">
						<fieldset>
						<!-- Form Name -->
						<legend><h2>Create New Invitation</h2></legend>
						<br>
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput"><br>Name</label>  
							<div class="col-sm-9">
								<input oncopy="return false" onpaste="return false" name="person_name" type="text" required="" class="form-control input-md"  maxlength="50">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput"><br>Rank</label>  
							<div class="col-sm-9">
								<input oncopy="return false" onpaste="return false" name="person_rank" type="text" required="" class="form-control input-md"  maxlength="30">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput">Event Name</label>  
							<div class="col-sm-9">
								<input oncopy="return false" onpaste="return false" name="event_name" type="text" required="" class="form-control input-md"  maxlength="100">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput">Event Category</label>  
							<div class="col-sm-9">
								<input oncopy="return false" onpaste="return false" name="event_category" type="text" required="" class="form-control input-md"  maxlength="20">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput">Event Day</label>  
							<div class="col-sm-9">
								<input oncopy="return false" onpaste="return false" name="event_day" type="date" required="" class="form-control input-md"  maxlength="30">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput">Time</label>  
							<div class="col-sm-9">
						...
						<div class="form-group row">
							...
							<div class="col-sm-9">
								<input oncopy="return false" onpaste="return false" name="event_venue" type="text" required="" class="form-control input-md"  maxlength="200">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 form-control-label" for="textinput"><br>Dress Code</label>  
							<div class="col-sm-9">
						...
						<div class="form-group row">
						  <div class="col-sm-offset-4 col-sm-6">
							<button type="submit" class="btn btn-primary">Print Invitation</button>
						  </div>
						</div>
						</fieldset> 
					</form>
