<?php
	...
	if(isset($_POST['change'])){
		if( $_POST['new_pass'] == $_POST['conf_pass']){
			...
			$login_info = "INSERT INTO `login` (`Manager_id`, `email`, `password`) VALUES (NULL, '$email', '$hashedpassword');";
			$res_login_info = $conn->query($login_info);
			...
			<div class="row carousel-holder">
				...
				<p class="bg-danger"><b><?php echo $error;?></b></p><br>
					<form action="" method="post" enctype="multipart/form-data" >
						...
						<div class="form-group col-md-9">
						<center> <button name="change" class="btn btn-info"> Add </button></center>
						</div>
					</form>
