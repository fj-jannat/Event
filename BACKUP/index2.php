    ...
    <div class="container">
		...
		<div class="col-md-3">
            <div class="list-group">
                ...
                <b>From:</b> <input class="list-group-item" name="login_email" placeholder="admin@email.com" type="date" /><br>
				<b>To:</b> <input class="list-group-item" name="login_email" placeholder="admin@email.com" type="date" /><br>
				<a class="btn btn-info btn-md" target="_blank" href="#"><i class="fa fa-search" aria-hidden="true"></i> Search</a>
            ...
            <div class="list-group">
				...
				while($row_category_search = $res_category_search->fetch_assoc()){
					...
					?>
				<a href="#" class="list-group-item"> <?php echo $event_cat ?></a>
				<?php
				}
                ?>
            </div>
                ...
                <div class="row">
					...
					?>
						<div class="col-sm-6 col-lg-6 col-md-6">
							<div class="thumbnail">
								<img src="Event/<?php echo $event_image ?>" alt="">
								<div class="caption">
									...
									<table style="width: 100%;">
										<tbody>
										<tr style="height: 5px;">
										<td style="height: 5px;"><font size="1"><strong>Category</strong></font></td>
										<td style="height: 5px;"><font size="1">&nbsp;<?php echo $event_category ?></font></td>
										</tr>
										<tr style="height: 20px;">
										<td style="height: 25px;"><strong>Time</strong></td>
										<td style="height: 25px;">&nbsp;<?php echo $event_time_from ." - ". $event_time_to ?></td>
										</tr>
										<tr style="height: 20px;">
										<td style="height: 23px;"><strong>Organizer</strong></td>
										<td style="height: 23px;">&nbsp;<?php echo $event_organizer ?></td>
										</tr>
										<tr style="height: 20px;">
										<td style="height: 23px;"><strong>Venue</strong></td>
										<td style="height: 23px;">&nbsp;<?php echo $event_venue ?></td>
										</tr>
										<tr style="height: 20px;">
										<td style="height: 23px;"><strong>Dress Code</strong></td>
										<td style="height: 23px;">&nbsp;DRESS</td>
										</tr>
										<tr style="height: 20px;">
										<td style="height: 23px;"><strong><font color= "green">Cost</font></strong></td>
										<td style="height: 23px;">&nbsp;<?php echo $event_cost ?></td>
										</tr>
										</tbody>
									</table>
